...
public class JSONUtil {
     ...
     *         <li>return
     *         {@link JSONUtil#getLong(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see {@link JSONUtil#getLong(JSONObject, String, Long)}
     */
    public static long getLong(JSONObject jsonObject, String key, long defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see {@link JSONUtil#getLong(String, String, Long)}
     */
    public static long getLong(String jsonData, String key, long defaultValue) {
     ...
     *         return defaultValue</li>
     *         <li>return
     *         {@link JSONUtil#getInt(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see {@link JSONUtil#getInt(JSONObject, String, Integer)}
     */
     ...
     * @param defaultValue
     * @return
     * @see {@link JSONUtil#getInt(String, String, Integer)}
     */
     ...
     *         return defaultValue</li>
     *         <li>return
     *         {@link JSONUtil#getDouble(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     * @param defaultValue
     * @return
     * @see {@link JSONUtil#getDouble(JSONObject, String, Double)}
     */
    public static double getDouble(JSONObject jsonObject, String key, double defaultValue) {
     ...
     * @param defaultValue
     * @return
     * @see {@link JSONUtil#getDouble(String, String, Double)}
     */
    public static double getDouble(String jsonData, String key, double defaultValue) {
     ...
     *         return defaultValue</li>
     *         <li>return
     *         {@link JSONUtil#getString(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         return defaultValue</li>
     *         <li>return
     *         {@link JSONUtil#getStringArray(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         return defaultValue</li>
     *         <li>return
     *         {@link JSONUtil#getJSONObject(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         return defaultValue</li>
     *         <li>return
     *         {@link JSONUtil#getJSONArray(JSONObject, String, JSONObject)}</li>
     *         </ul>
     */
     ...
     *         return defaultValue</li>
     *         <li>return
     *         {@link JSONUtil#getBoolean(JSONObject, String, Boolean)}</li>
     *         </ul>
     */
     ...
     *         {@link MapUtil#putMapNotEmptyKey(Map, String, String)} one by
     *         one</li>
     *         </ul>
     */
